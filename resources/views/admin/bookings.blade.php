...
$bookings = [
    ...
    ['id' => 2, 'ref' => 'BK002', 'guest' => 'Baskara Putra', 'room' => '104', 'checkin' => '14-03-2026', 'checkout' => '16-03-2026', 'pax' => 1, 'amount' => 890000, 'status' => 'Pending'],
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-3">
                <div class="booking-stat-card">
                    ...
                    <div class="booking-stat-value text-dark-value">8</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="booking-stat-card">
                    <div class="booking-stat-title">Confirmed <i class="fas fa-check-double"></i></div>
                    <div class="booking-stat-value">5</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="booking-stat-card">
                    <div class="booking-stat-title">Pending <i class="far fa-clock"></i></div>
                    <div class="booking-stat-value">1</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="booking-stat-card">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-9">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control search-input border-start-0 ps-0" placeholder="Search by booking ref, guest name...">
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="table-responsive">
                <table class="table custom-table text-center align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-bold text-dark">{{ $b['ref'] }}</td>
                            <td>{{ $b['guest'] }}</td>
                            <td>{{ $b['room'] }}</td>
                            <td>{{ $b['checkin'] }}</td>
                            <td>{{ $b['checkout'] }}</td>
                            ...
                            <td>
                                ...
                                @elseif($b['status'] == 'Pending') <span class="status-badge badge-pending">Pending</span>
                                    ...
                                    <div class="modal-body p-4">
                                        ...
                                        <div class="d-flex gap-3">
                                            <form action="#" method="POST" class="flex-grow-1">
                                                @csrf
                                                <button type="submit" class="btn w-100 btn-confirm-booking">Confirm Booking</button>
                                            </form>
                                            <form action="#" method="POST" class="flex-grow-1">
                                                @csrf
                                                <button type="submit" class="btn w-100 btn-cancel-booking">Cancel Booking</button>
                                            </form>
                                        </div>
                                        @endif
