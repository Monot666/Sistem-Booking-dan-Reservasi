...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/content_creator/style.css') }}?v={{ time() }}">
</head>
<body>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4 card-konfirmasi">
                    <div class="layout-card">
                        ...
                        <button class="btn-pilih" onclick="showEditLayout('Konfirmasi Pembayaran', 'conf', '{{ asset('assets/img/content_creator/konfirmasi-pembayaran.png') }}', '{{ $conf['image'] }}', '{{ $conf['link'] }}')">Pilih</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="view-upload" style="display: none;">
            ...
            <div class="upload-container text-center">
                ...
                <div id="dynamic-upload-zones">
                    ...
                    <div class="upload-block foto-1" id="upload-block-1">
                    ...
                    <div class="upload-block foto-2 mt-5 pt-3" id="upload-block-2" style="display: none; border-top: 2px dashed #e2e8f0;">
                    ...
                    <div class="upload-block foto-3 mt-5 pt-3" id="upload-block-3" style="display: none; border-top: 2px dashed #e2e8f0;">
                    ...
                    <div class="upload-block foto-4 mt-5 pt-3" id="upload-block-4" style="display: none; border-top: 2px dashed #e2e8f0;">
